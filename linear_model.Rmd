...
We hypothesize that for pre- and post-pandemic periods, the personal consumption expenditure pattern has changed with respect to personal income. To test this hypothesis, we will fit a linear model using data from year 1967-2018, the "pre-pandemic" period. And then
