...
Overall, all variables and PCE has a linear relationship with each other. 

### Model fitting

We hypothesize that for pre- and post-pandemic periods, the personal consumption expenditure pattern has changed with respect to personal income. To test this hypothesis, we will fit a linear model using data from year 1967-2018, the "pre-pandemic" period. We will use this model to predict PCE outcomes for a per-pandemic year, 2019, and a post-pandemic year, 2020, respectively. To include the 
