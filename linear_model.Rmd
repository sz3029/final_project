...
We can also look at the time v.s. logarithm dollars graph. Clearly, there is a increasing trend as time proceeded.
...
We hypothesize that the We will fit a linear model using data from year 1967-2018, the "pre-pandemic" period. And then
